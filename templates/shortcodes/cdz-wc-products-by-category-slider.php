...
<div id="cdz-wc-products-by-category-slider-<?php echo $rand_num; ?>" class="cdz-wc-products-by-category-slider swiper-container">
	...
	<div id="cdz-wc-products-by-category-slider-button-prev-<?php echo $rand_num; ?>" class="swiper-button-prev"></div>
	<div id="cdz-wc-products-by-category-slider-button-next-<?php echo $rand_num; ?>" class="swiper-button-next"></div>
...
<script>
	var mySwiper = new Swiper('#cdz-wc-products-by-category-slider-<?php echo $rand_num; ?>', {
        ...
        nextButton: '#cdz-wc-products-by-category-slider-button-next-<?php echo $rand_num; ?>',
        prevButton: '#cdz-wc-products-by-category-slider-button-prev-<?php echo $rand_num; ?>',
		spaceBetween: 30,
