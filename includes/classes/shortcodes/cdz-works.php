...
if ( ! function_exists( 'cdz_sc_works' ) ) {

	function cdz_sc_works( $atts = NULL ) {
		...
		if ( $the_query->have_posts() ) : ?>
			...
			<div class="cdz-shortcode cdz-works">
		...
		<?php else : ?>
			...
			<div class="cdz-shortcode no-posts"><p><?php echo __( 'No works' ); ?>...</p></div>
	...
	add_shortcode( 'cdz_works', 'cdz_sc_works' );
