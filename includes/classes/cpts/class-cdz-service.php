...
class cdz_Service {
	...
	function box_customer() {
		...
		echo '<p><label for="cdz_service_custom_url_label">' . __( 'Custom URL Label', 'cdz' ) . ' - <i>"' . __( 'URL', 'cdz' ) . ':"</i></label></p>';
		echo '<input type="text" name="cdz_service_custom_url_label" value="' . $cdz_service_custom_url_label  . '" id="cdz_service_custom_url_label" class="widefat" />';
	...
	function save_meta( $post_id, $post ) {
		...
		$cdz_service_meta['cdz_service_custom_url_label']	= $_POST['cdz_service_custom_url_label'];
	...
	function manage_posts_custom_column( $name ) {
		...
		if		( $name == 'cdz_service_thumb' )		{ echo get_the_post_thumbnail( $post->ID, 'thumbnail' ); }
